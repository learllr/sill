...
export default function EditDocumentForm({
  ...
  const [formFields, setFormFields] = useState({
    ...
    invoiceNumber: document.invoiceInfos?.invoiceNumber || "",
    lot: document.invoiceInfos?.lot || document.quoteInfos?.lot || "",
    paidOn: document.invoiceInfos?.paidOn || "",
    paymentMethod: document.invoiceInfos?.paymentMethod || "",
    remarks: document.remarks || "",
    sentOn: document.quoteInfos?.sentOn || "",
    status: document.quoteInfos?.status || "En attente",
    RG: document.invoiceInfos?.RG || false,
    prorata: document.invoiceInfos?.prorata || false,
    finalCompletion: document.invoiceInfos?.finalCompletion || false,
